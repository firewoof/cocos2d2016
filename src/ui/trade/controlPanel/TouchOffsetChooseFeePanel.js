 ...
 */
var TouchOffsetChooseFeePanel = BaseTradeControlPanel.extend({
    ...
    initUI:function()
    {
        ...
        var rootNode = ccs.load(res.TradeControlTouchOffsetFee_json).node;
        ...
        var feeText = this._feeText = ccui.helper.seekWidgetByName(betSelectedPanel, "feeText");
    ...
    refreshBetInput:function(betAmount, isNeedCheckValid)
    {
        ...
        var fee  = (((1 - curOdds) * this._betAmount)/2).toFixed(2);
    ...
    touchOffsetSelected:function(index)
    {
        ...
        //记住
        cc.sys.localStorage.setItem("selectedOffsetIndex_"+productInfo.getId(), index);
