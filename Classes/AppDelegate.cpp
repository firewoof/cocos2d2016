...
//#if (CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID /*|| CC_TARGET_PLATFORM == CC_PLATFORM_IOS*/)
//	// Init the Bugly
//	/*CrashReport::setAppChannel("Official");
//	CrashReport::setAppVersion("1.2.0");*/
//	CrashReport::initCrashReport("114b50d1a9", true, CrashReport::CRLogLevel::Info);
//#endif
    ...
    if(!glview) {
        ...
        glview = cocos2d::GLViewImpl::create("Spinage");
#else
        glview = cocos2d::GLViewImpl::createWithRect("Spinage", Rect(0,0,1334,750));
#endif
	...
	// ccui的扩展
	sc->addRegisterCallback(register_all_cocos2dx_ui_custom);
